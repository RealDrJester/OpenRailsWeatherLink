...
class OpenRailsParser:
    ...
    def get_activity_details(self, act_path_str):
        ...
        weather_events = re.findall(r'EventCategoryTime\s*\(.*?ORTSWeatherChange.*?\)', content, re.DOTALL)
    ...
    def get_activity_path_coords(self, route_path_str, path_id):
        ...
        # Working parsing logic for TrackPDP and TrPathNode (from working version)

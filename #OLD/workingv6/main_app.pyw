...
class MainApplication(tk.Tk):
    ...
    def run_chaotic_generation(self): self.run_generation_thread(chaotic=True)
    def generate_weather_worker(self, chaotic=False):
        ...
        if chaotic:
            ...
            weather_events, msg = self.weather.create_weather_events_string(lat, lon, season, date_obj, start_hour)

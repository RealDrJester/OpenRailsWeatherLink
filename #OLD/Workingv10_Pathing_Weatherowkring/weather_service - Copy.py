...
class WeatherService:
    ...
    def create_weather_events_string(self, lat, lon, season, force_snow, date_obj=None, start_hour=0):
        ...
        def map_weather(wmo, cloud, precip, vis, current_season, snow_forced):
        ...
        try:
            for i in range(48):
                ...
                p = map_weather(wmo, get_val("cloudcover"), get_val("precipitation"), get_val("visibility"), season, force_snow)
    ...
    def create_chaotic_weather_events(self):
        ...
        weather_states = [
            ...
            {"Overcast": 0.9, "Fog": 2000, "Precipitation": 0.018, "Liquidity": 0.0},
        ]
        for i in range(48):

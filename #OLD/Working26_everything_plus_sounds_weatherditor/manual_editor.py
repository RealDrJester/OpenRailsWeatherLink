...
class ManualWeatherEditor(tk.Toplevel):
    ...
    def draw_timeline(self):
        ...
        for i, (time_val, item_id) in enumerate(items):
            ...
            self.timeline_canvas.create_rectangle(start_x, 0, end_x, height, fill=color, outline="black")
            self.timeline_canvas.create_text(start_x + 5, height/2, text=f"{time_val}s", anchor="w")

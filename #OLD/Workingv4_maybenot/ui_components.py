...
class DateSelectionWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        if TKCALENDAR_AVAILABLE:
            self.cal = DateEntry(main_frame, selectmode='day', date_pattern='yyyy-mm-dd', maxdate=date.today())
            self.cal.grid(row=0, column=1, sticky="ew")
...
class ForecastChart(ttk.Frame):
    def __init__(self, parent):
        ...
        self.ax2 = self.ax1.twinx() # For precipitation

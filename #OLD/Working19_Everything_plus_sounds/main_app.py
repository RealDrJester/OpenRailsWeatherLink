...
class MainApplication(tk.Tk):
    ...
    def _update_map_with_path(self, path_coords):
        ...
        if len(path_coords) >= 2:
            ...
            # --- FIX: Calculate bounding box manually for robustness ---
    ...
    def generate_weather_worker(self, chaotic=False, preset_name=None):
        ...
        self.log("[Debug] Sound manager copy cache cleared for new run.")
        ...
        if chaotic:
            ...
            self.log(f"[Debug] Generation Params: force_snow={force_snow}, add_thunder={add_thunder}, add_wind={add_wind}, add_rain={add_rain}")

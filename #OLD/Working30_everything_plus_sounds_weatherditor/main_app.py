...
class MainApplication(tk.Tk):
    ...
    def setup_ui(self):
        ...
        Tooltip(self.route_listbox, "Lists all routes found in the selected Content folder. Click to select a route.")
        ...
        Tooltip(self.generate_button, "Generates a new activity (.act) file with the fetched weather data.")

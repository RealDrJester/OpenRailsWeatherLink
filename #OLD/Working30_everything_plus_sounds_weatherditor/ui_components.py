...
class StartupInfoWindow(tk.Toplevel):
    def __init__(self, parent, config):
        ...
        text = (
            ...
            "- Sound Playback: The injection of custom sounds into activities is subject to the limitations of the Open Rails sound engine. Sounds may occasionally overlap or behave unexpectedly.\n\n"
...
class AboutWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        create_link(main_frame, "This Software's GitHub Repository", "https://github.com/RealDrJester/OpenRailsWeatherLink/")
